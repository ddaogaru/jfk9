...
function getHeaderHeight() {
    ...
    var _header_offsetHeight;
    const fallback = (_header_offsetHeight = header === null || header === void 0 ? void 0 : header.offsetHeight) !== null && _header_offsetHeight !== void 0 ? _header_offsetHeight : DEFAULT_HEADER_FALLBACK;
    const rootStyles = getComputedStyle(document.documentElement);
...
function scrollToSection(target) {
    ...
    var _options_offset;
    const headerOffset = (_options_offset = options.offset) !== null && _options_offset !== void 0 ? _options_offset : getHeaderHeight();
    ...
    const handleContactScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Services.useCallback[handleContactScroll]": ()=>{
            ...
            if (window.location.pathname === '/') {
                const didScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scroll$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scrollToSection"])('#contact');
                if (!didScroll) {
