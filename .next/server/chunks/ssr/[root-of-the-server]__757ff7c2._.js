...
"[externals]/canvas-confetti [external] (canvas-confetti, cjs, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/[externals]_canvas-confetti_6f6da084._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[externals]/canvas-confetti [external] (canvas-confetti, cjs)");
    });
});
}),
];