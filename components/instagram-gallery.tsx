...
const InstagramGallery = () => {
  ...
  return (
    <section id="gallery" className="bg-white shadow-none">
      <div className="container mx-auto px-15 pt-[15px] pb-[15px]">
        <div className="text-center flex flex-col items-center justify-center content-block gap-15">
          ...
          <h2 className="w-full font-bold text-center text-brand-navy text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight">
            Follow Our Journey
          </h2>

          <p className="text-base sm:text-lg md:text-xl text-brand-navy text-center leading-normal px-15 w-full max-w-[800px]">
            See our latest training sessions, workshops, and proud K9 partners
            on Instagram.
          </p>
          ...
          <div className="flex justify-center w-full mt-15">
            <div className="w-full responsive-width max-w-[800px]">
              <blockquote
              ...
              >
                <div className="p-0">
                  ...
                  >
                    ...
                    <div className="block h-[50px] w-[50px] mx-auto mb-[12px]">
                      <svg
          ...
          {/* Press Section */}
          {/* Make press observable for IntersectionObserver */}
          <div id="press" className="mt-15">
            <CustomBadge
              variant="blue-line-red-text"
              inline={true}
              className="!mb-0 !py-0"
