                        ...
                        <Card className="flex-none shrink-0 overflow-hidden border border-border/50 hover:border-[#B31942]/50 transition-all duration-300 h-[600px] w-full max-w-none">
                          <CardContent className="p-0 flex-grow overflow-y-auto custom-scrollbar">
                            ...
                            {trainingServices[currentTrainingIndex].id === "obedience" && (
                              <>
                                <h2 className="text-lg sm:text-xl font-bold text-[#B31942] mt-0 mb-3 sm:mb-4">Obedience Training Packages</h2>
                                <p>
                                  We offer several obedience programs based on how hands-on you want to be. All options include clear homework, progress check-ins, and practical skills for real-life settings. Payment plans are available.
                                </p>
                                <h2 className="text-lg sm:text-xl font-bold text-[#B31942] mt-4 sm:mt-6 mb-3 sm:mb-4">Board and Train — starting at $950/week</h2>
                                <p className="mb-4">
                                  Your dog boards at our <strong>Northwest Arkansas</strong> facility and trains daily with our team. We teach new behaviors and address unwanted ones, with an average stay of 2–4 weeks depending on goals and temperament.
                                </p>
                                <p className="mb-2"><strong>Core skills covered:</strong> Sit, Down, Heel, Climb/Place, Come, and Free (release).</p>
                                <p className="mb-2"><strong>Teaching method:</strong> Verbal commands by default, with any alternate cues discussed with you before training begins.</p>
                                <p className="mb-4"><strong>Owner support:</strong> One owner lesson for every two weeks of training plus a follow-up after your dog goes home.</p>
                                
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Drop-Off Dog Training — starting at $750/week</h2>
                                <p className="mb-4">
                                  Get the same curriculum as our Board and Train while your dog sleeps at home. You&apos;ll drop off in the morning and pick up in the evening—like school for your dog.
                                </p>
                                <p className="mb-2"><strong>Core skills covered:</strong> Sit, Down, Heel, Climb/Place, Come, and Free.</p>
                                <p className="mb-4"><strong>Owner support:</strong> One owner lesson for every two weeks of training plus a post-program follow-up.</p>
                                
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Private Lessons — starting at $500 for four one-hour sessions</h2>
                                <p className="mb-4">
                                  Ideal if you want to be hands-on at the end of the leash. We coach you to teach your dog effectively and tailor the plan to your priorities.
                                </p>
                                <p className="mb-2"><strong>Format:</strong> Four one-hour sessions.</p>
                                <p className="mb-4"><strong>Focus areas:</strong> Customized to your goals (manners, leash work, recall, household rules, and more).</p>
                                
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Off-Site (In-Home) Private Training — starting at $900 for four one-hour sessions</h2>
                                <p className="mb-4">
                                  Enjoy private lessons at your home or another agreed-upon location for maximum real-world carryover.
                                </p>
                                <p className="mb-2"><strong>Format:</strong> Four one-hour sessions at your location.</p>
                                <p className="mb-4"><strong>Evaluation:</strong> $50 initial in-home evaluation, credited to your first lesson if you enroll during that visit.</p>
                                
                                <p className="mt-4"><strong>Final recommendations and timelines vary by dog, goals, and environment. We&apos;ll help you choose the program that fits your needs and lifestyle.</strong></p>
                              </>
                            )}
                            {trainingServices[currentTrainingIndex].id === "aggressive" && (
                              <>
                                <h2 className="text-xl font-bold text-[#B31942] mt-0 mb-4">Aggressive Dog Training in Northwest Arkansas</h2>
                                <p>
                                  At <strong>Joint Forces K9 Group</strong>, we specialize in rehabilitating dogs with aggressive or reactive behaviors across <strong>Northwest Arkansas</strong>. Our trainers help restore calm, safety, and trust at home while giving owners clear, practical tools that work in everyday life.
                                </p>
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">What We Address</h2>
                                <ul className="list-disc space-y-4 mb-0 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Our Approach</h2>
                                <p className="mb-4">
                                  Aggression is often rooted in stress, fear, or confusion. We focus on changing emotions and behaviors—not your dog&apos;s personality—through a structured, humane program.
                                </p>
                                <ol className="list-decimal space-y-4 mb-0 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Early Warning Signs to Watch</h2>
                                <p>
                                ...
                                <p>
                                  We serve every community across <strong>Northwest Arkansas</strong>, including major hubs like <strong>Fayetteville</strong>, <strong>Springdale</strong>, <strong>Rogers</strong>, and <strong>Bentonville</strong>. Our service also extends to surrounding towns such as <strong>Siloam Springs</strong>, <strong>Centerton</strong>, <strong>Bella Vista</strong>, <strong>Pea Ridge</strong>, <strong>Tontitown</strong>, <strong>Gentry</strong>, <strong>Cave Springs</strong>, <strong>Gravette</strong>, <strong>Decatur</strong>, <strong>Greenland</strong>, <strong>Lincoln</strong>, <strong>Farmington</strong>, <strong>Prairie Grove</strong>, <strong>Johnson</strong>, <strong>West Fork</strong>, <strong>Eureka Springs</strong>, <strong>Goshen</strong>, <strong>Elkins</strong>, <strong>Little Flock</strong>, <strong>Bethel Heights</strong>, and <strong>Highfill</strong>.
                                </p>
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Why Joint Forces K9 Group</h2>
                                <ul className="list-disc space-y-4 mb-0 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Get Started</h2>
                                <p><strong>If your dog is showing aggression or severe reactivity, earlier is better. Request a consultation to begin a customized behavior-modification plan that brings calm back to your home.</strong></p>
                              </>
                            )}
                            {trainingServices[currentTrainingIndex].id === "protection" && (
                              <>
                                <h2 className="text-xl font-bold text-[#B31942] mt-0 mb-4">Protection Dog Training in Northwest Arkansas</h2>
                                <p className="mb-4">
                                  Protection dog training is more than teaching a dog to guard or bark—it&apos;s about building a reliable partnership. Our goal is a dog that can protect you, your family, or your business while staying obedient, stable, and well-mannered around children, guests, and everyday distractions.
                                </p>
                                <p className="mb-4">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">The Importance of Imprinting and Socialization</h2>
                                <p className="mb-4">
                                  Imprinting and socialization form the foundation of effective protection work.
                                </p>
                                <ul className="list-disc space-y-4 mb-0 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Protection Sports Pathways</h2>
                                <p className="mb-4">
                                  We offer guidance and training along recognized protection-sport tracks. These sports test obedience, control under pressure, and sound temperament—qualities central to real-world protection.
                                </p>
                                <h3 className="text-lg font-bold text-[#B31942] mt-4 mb-3">PSA (Protection Sports Association)</h3>
                                <p className="mb-4">
                                  Often called the &quot;MMA of protection sports&quot; for its dynamic, scenario-based challenges, PSA continually tests the dog–handler team in changing environments.
                                </p>
                                ...
                                <h3 className="text-lg font-bold text-[#B31942] mt-4 mb-3">IPO/Schutzhund (Protection, Obedience, Tracking)</h3>
                                <p className="mb-4">
                                  Formerly known as Schutzhund (SchH), IPO is a structured sport emphasizing precision and control across three phases: Tracking, Obedience, and Protection.
                                </p>
                                <ul className="list-disc space-y-2 mb-4 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">What You Can Expect</h2>
                                <ul className="list-disc space-y-4 mb-0 pl-5">
                            ...
                            {trainingServices[currentTrainingIndex].id === "service" && (
                              <>
                                <h2 className="text-xl font-bold text-[#B31942] mt-0 mb-4">Service Dog Training in Northwest Arkansas</h2>
                                <p className="mb-4">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">What Is a Service Dog?</h2>
                                <p className="mb-4">
                                  Under the ADA, a service dog is a dog that is individually trained to do work or perform tasks for a person with a disability (including physical, sensory, psychiatric, intellectual, or other mental disabilities). The work or tasks must directly mitigate the person&apos;s disability.
                                </p>
                                <ul className="list-disc space-y-2 mb-4 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">How Do I Get a Service Dog?</h2>
                                <p className="mb-4">
                                  There are several paths. We do not breed or sell service dogs; instead, we help you select an appropriate dog (or evaluate your current dog) and train it for task work and public access.
                                </p>
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Our Process</h2>
                                <ol className="list-decimal space-y-4 mb-4 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Types of Working Dogs We Train</h2>
                                <ul className="list-disc space-y-2 mb-4 pl-5">
                                ...
                                <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Example Tasks (Customized to Your Needs)</h2>
                                <ul className="list-disc space-y-2 mb-4 pl-5">
                    ...
                    <CardContent className="p-0 flex-grow overflow-y-auto custom-scrollbar">
                      <div className="p-4">
                        <div className="prose prose-slate max-w-none">
                          ...
                          <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Our Specialized K9 Detection Advantage</h2>

                          <ul className="list-disc space-y-2 mb-0 pl-5">
                          ...
                          <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Our Confidential & Professional Search Process</h2>

                          <p>To protect all parties and ensure maximum effectiveness, our process is built on a foundation of safety and legality.</p>

                          <div className="h-4" />

                          <ol className="list-decimal space-y-2 mb-0 pl-5">
                          ...
                          <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Our Commitment: Detection, Not Confiscation</h2>
                          ...
                          <h2 className="text-xl font-bold text-[#B31942] mt-6 mb-4">Who We Serve: Industries & Clients</h2>
                          ...
                          <p className="mt-4 text-center"><strong>Secure your peace of mind. Contact us today for a confidential consultation.</strong></p>
