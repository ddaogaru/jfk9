...
const Services = ({
  ...
  const prevTraining = useCallback(() => {
    setCurrentTrainingIndex(
      (prev) => (prev - 1 + trainingServices.length) % trainingServices.length,
    );
  }, [trainingServices.length]);

  // Keyboard navigation support - only when component is focused
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      // Only handle keyboard events if the services section is focused or contains focus
      const servicesSection = document.getElementById('services');
      const activeElement = document.activeElement;
      
      if (!servicesSection || !activeElement) return;
      
      const isWithinServices = servicesSection.contains(activeElement);
      
      if (activeService === "training" && isWithinServices) {
    ...
    <section id="services" className="bg-brand-red w-full">
      <div className="container mx-auto container-spacing">
        <div className="flex flex-col items-center justify-center text-center gap-15 mb-15">
          ...
          <CustomTitle className="w-full mx-auto text-white">
            Comprehensive Dog Training & Care
          </CustomTitle>
          <CustomSubtitle className="w-full mx-auto text-white">
        ...
        >
          <TabsList className="flex flex-wrap justify-center gap-15 bg-transparent">
            <TabsTrigger
              value="boarding"
              className="flex flex-col sm:flex-row items-center justify-center px-15 py-15 text-xs md:text-sm lg:text-base font-medium bg-brand-navy text-white data-[state=active]:bg-white data-[state=active]:text-brand-navy hover:bg-white/90 hover:text-brand-navy border border-brand-navy/20 shadow-lg hover:shadow-xl transition-all text-center"
            >
            ...
            <TabsContent key={service.id} value={service.id}>
              ...
              >
                {service.id === "training" ? (
                        ...
                        <CardContent className="p-0 flex-grow overflow-y-auto custom-scrollbar">
                          <div className="p-0">
                            <h3 className="text-xl font-semibold text-brand-navy mb-15">
                              {trainingServices[currentTrainingIndex].title}
                            </h3>
                            <div className="text-muted-foreground space-y-[15px]">
                              <div className="prose prose-slate dark:prose-invert max-w-none space-y-[15px]">
                                <div className="space-y-[15px]">
                                  {trainingServices[currentTrainingIndex].id ===
                                    "obedience" && (
                                    <>
                                      <h2 className="text-lg sm:text-xl font-bold text-brand-red">
                                        Obedience Training Packages
                                      </h2>
                                      <p>
                                        We offer several obedience programs
                                        based on how hands-on you want to be.
                                        All options include clear homework,
                                        progress check-ins, and practical skills
                                        for real-life settings. Payment plans
                                        are available.
                                      </p>
                                      <h2 className="text-lg sm:text-xl font-bold text-brand-red">
                                        Board and Train — starting at $950/week
                                      ...
                                      <p className="">
                                        ...
                                        facility and trains daily with our team.
                                        We teach new behaviors and address
                                        unwanted ones, with an average stay of
                                        2–4 weeks depending on goals and
                                        temperament.
                                      </p>
                                      <p className="">
                                        <strong>Core skills covered:</strong>{" "}
                                        Sit, Down, Heel, Climb/Place, Come, and
                                        Free (release).
                                      </p>
                                      <p className="">
                                        <strong>Teaching method:</strong> Verbal
                                        commands by default, with any alternate
                                        cues discussed with you before training
                                        begins.
                                      </p>
                                      <p className="">
                                        <strong>Owner support:</strong> One
                                        owner lesson for every two weeks of
                                        training plus a follow-up after your dog
                                        goes home.
                                      </p>

                                      <h2 className="text-xl font-bold text-brand-red">
                                        Drop-Off Dog Training — starting at
                                        $750/week
                                      </h2>
                                      <p className="">
                                        Get the same curriculum as our Board and
                                        Train while your dog sleeps at home.
                                        You&apos;ll drop off in the morning and
                                        pick up in the evening—like school for
                                        your dog.
                                      </p>
                                      <p className="">
                                        <strong>Core skills covered:</strong>{" "}
                                      ...
                                      <p className="">
                                        <strong>Owner support:</strong> One
                                        owner lesson for every two weeks of
                                        training plus a post-program follow-up.
                                      </p>

                                      <h2 className="text-xl font-bold text-brand-red">
                                        Private Lessons — starting at $500 for
                                        four one-hour sessions
                                      </h2>
                                      <p className="">
                                        Ideal if you want to be hands-on at the
                                        end of the leash. We coach you to teach
                                        your dog effectively and tailor the plan
                                        to your priorities.
                                      </p>
                                      <p className="">
                                        <strong>Format:</strong> Four one-hour
                                        sessions.
                                      </p>
                                      <p className="">
                                        <strong>Focus areas:</strong> Customized
                                        to your goals (manners, leash work,
                                        recall, household rules, and more).
                                      </p>

                                      <h2 className="text-xl font-bold text-brand-red">
                                        Off-Site (In-Home) Private Training —
                                        starting at $900 for four one-hour
                                        sessions
                                      </h2>
                                      <p className="">
                                        Enjoy private lessons at your home or
                                        another agreed-upon location for maximum
                                      ...
                                      <p className="">
                                        <strong>Evaluation:</strong> $50 initial
                                        in-home evaluation, credited to your
                                        first lesson if you enroll during that
                                        visit.
                                      </p>

                                      <p className="">
                                        <strong>
                                          Final recommendations and timelines
                                          vary by dog, goals, and environment.
                                          We&apos;ll help you choose the program
                                  ...
                                  {trainingServices[currentTrainingIndex].id ===
                                    ...
                                    <>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Aggressive Dog Training in Northwest
                                        Arkansas
                                      </h2>
                                      <p>
                                        At{" "}
                                        <strong>Joint Forces K9 Group</strong>,
                                        we specialize in rehabilitating dogs
                                        with aggressive or reactive behaviors
                                        across{" "}
                                        <strong>Northwest Arkansas</strong>. Our
                                        trainers help restore calm, safety, and
                                        trust at home while giving owners clear,
                                        practical tools that work in everyday
                                        life.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        What We Address
                                      ...
                                      <p className="">
                                        Aggression is often rooted in stress,
                                        fear, or confusion. We focus on changing
                                        emotions and behaviors—not your
                                        dog&apos;s personality—through a
                                      ...
                                      <ol className="list-decimal pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            We evaluate history, triggers,
                                            routines, environment, and handling
                                            to understand why behaviors occur
                                            and when they&apos;re likely to
                                            surface.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            We tailor a step-by-step plan that
                                            may include desensitization,
                                            counter-conditioning, confidence
                                            building, foundation obedience, and
                                            household structure—plus clear
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            We prioritize management and safe
                                            handling (distance, thresholds,
                                            appropriate tools). You&apos;ll
                                            learn exactly what to do during
                                            walks, door greetings, guest
                                            interactions, and multi-dog
                                            situations.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            Regular sessions and simple daily
                                            reps build reliable habits. We
                                            adjust the plan as your dog improves
                                            to keep momentum and prevent
                                            setbacks.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Veterinary Collaboration When
                                              Needed
                                            </strong>
                                            <br />
                                            If appropriate, we coordinate with
                                            your veterinarian to rule out pain
                                            or medical contributors and discuss
                                            whether medication may support
                                            training.
                                          </span>
                                        </li>
                                      </ol>
                                      ...
                                      <p>
                                        <strong>Stiff posture</strong>,{" "}
                                        <strong>hard stare</strong>,{" "}
                                        <strong>lip lift</strong>,{" "}
                                        <strong>growling</strong>,{" "}
                                        <strong>freezing</strong>, and{" "}
                                        <strong>sudden lunging</strong> are
                                        common precursors to escalation.
                                        Addressing these signals early improves
                                        outcomes and keeps everyone safer.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Service Area
                                      </h2>
                                      <p>
                                        ...
                                        <strong>Springdale</strong>,{" "}
                                        <strong>Rogers</strong>, and{" "}
                                        <strong>Bentonville</strong>. Our
                                        service also extends to surrounding
                                        towns such as{" "}
                                        <strong>Siloam Springs</strong>,{" "}
                                        <strong>Centerton</strong>,{" "}
                                        <strong>Bella Vista</strong>,{" "}
                                        <strong>Pea Ridge</strong>,{" "}
                                        <strong>Tontitown</strong>,{" "}
                                        <strong>Gentry</strong>,{" "}
                                        <strong>Cave Springs</strong>,{" "}
                                        <strong>Gravette</strong>,{" "}
                                        <strong>Decatur</strong>,{" "}
                                        <strong>Greenland</strong>,{" "}
                                        <strong>Lincoln</strong>,{" "}
                                        <strong>Farmington</strong>,{" "}
                                        <strong>Prairie Grove</strong>,{" "}
                                        <strong>Johnson</strong>,{" "}
                                        <strong>West Fork</strong>,{" "}
                                        <strong>Eureka Springs</strong>,{" "}
                                        <strong>Goshen</strong>,{" "}
                                        <strong>Elkins</strong>,{" "}
                                        <strong>Little Flock</strong>,{" "}
                                        <strong>Bethel Heights</strong>, and{" "}
                                        <strong>Highfill</strong>.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Why Joint Forces K9 Group
                                      </h2>
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            who regularly work complex
                                            reactivity and aggression cases
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Balanced, evidence-informed
                                              methods
                                            </strong>{" "}
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            and owner education for real-world
                                            results
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                      ...
                                      <p>
                                        <strong>
                                          If your dog is showing aggression or
                                          severe reactivity, earlier is better.
                                          Request a consultation to begin a
                                          customized behavior-modification plan
                                          that brings calm back to your home.
                                        </strong>
                                      </p>
                                    </>
                                  )}
                                  {trainingServices[currentTrainingIndex].id ===
                                    ...
                                    <>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Protection Dog Training in Northwest
                                        Arkansas
                                      </h2>
                                      <p className="">
                                        Protection dog training is more than
                                        teaching a dog to guard or
                                        bark—it&apos;s about building a reliable
                                        partnership. Our goal is a dog that can
                                        protect you, your family, or your
                                        business while staying obedient, stable,
                                        and well-mannered around children,
                                        guests, and everyday distractions.
                                      </p>
                                      <p className="">
                                        We tailor programs to your
                                        lifestyle—family protection, personal
                                        security, or business support—so your
                                        dog learns to follow commands, work
                                        through distractions, and respond
                                        appropriately to potential threats
                                        without becoming indiscriminately
                                        aggressive. Every plan is honest,
                                        effective, and matched to your
                                        dog&apos;s temperament.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        The Importance of Imprinting and
                                        Socialization
                                      </h2>
                                      <p className="">
                                        Imprinting and socialization form the
                                        foundation of effective protection work.
                                      </p>
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            with people, places, sounds,
                                            surfaces, and environments build
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            teaches neutrality and focus under
                                            distraction, reducing unnecessary
                                            aggression.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Imprinting clarifies expectations
                                            </strong>
                                            —what to do, when to do it, and how
                                            to recover (on and off switches).
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            is a dog that can calmly navigate
                                            daily life—at home, around children
                                            and guests, and in public—while
                                            possessing the clarity and control
                                      ...
                                      <p className="">
                                        We offer guidance and training along
                                        recognized protection-sport tracks.
                                        These sports test obedience, control
                                        under pressure, and sound
                                        temperament—qualities central to
                                      ...
                                      <p className="">
                                        Often called the &quot;MMA of protection
                                        sports&quot; for its dynamic,
                                        scenario-based challenges, PSA
                                        continually tests the dog–handler team
                                      ...
                                      <ul className="list-disc pl-0">
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Temperament, nerve strength,
                                            environmental stability, and clear
                                            recoveries are key.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Solid obedience is a prerequisite
                                            for advanced protection work.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Dogs learn to engage and release on
                                            command, maintain obedience in
                                            complex scenarios, and remain
                                            responsive to the handler despite
                                            distractions and stressors.
                                          </span>
                                        </li>
                                      </ul>
                                      <h3 className="text-lg font-bold text-brand-red">
                                        IPO/Schutzhund (Protection, Obedience,
                                        Tracking)
                                      </h3>
                                      <p className="">
                                        Formerly known as Schutzhund (SchH), IPO
                                        is a structured sport emphasizing
                                        precision and control across three
                                        phases: Tracking, Obedience, and
                                        Protection.
                                      </p>
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Helpers typically use a sleeve;
                                            exercises may include courage tests,
                                            escape bites, transport, search &
                                            guard, and controlled engagements.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Dogs must engage on cue, out/return
                                            promptly, and demonstrate neutrality
                                            when not working.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Training builds the ability to move
                                            cleanly between passive and active
                                            states, maintaining clarity, safety,
                                      ...
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Suitability and safety are evaluated
                                            before advanced work begins.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            We prioritize clean outs, steady
                                            grips, neutrality, and reliable
                                            recalls.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            Real-world proofing for noise,
                                            surfaces, crowds, and environmental
                                            stressors.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            You&apos;ll learn timing, leash
                                            mechanics, cue delivery, and safety
                                            protocols.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            We focus on measured, purpose-driven
                                            training—never indiscriminate
                                            aggression.
                                          </span>
                                        </li>
                                      </ul>
                                      ...
                                      <p>
                                        <strong>
                                          ...
                                          protection dog or want to develop your
                                          current dog&apos;s potential, schedule
                                          a consultation. We&apos;ll assess
                                          temperament, outline a clear plan, and
                                          recommend the path—family protection,
                                          PSA, or IPO—that best fits your goals.
                                        </strong>
                                      </p>
                                    </>
                                  )}
                                  {trainingServices[currentTrainingIndex].id ===
                                    ...
                                    <>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Service Dog Training in Northwest
                                        Arkansas
                                      </h2>
                                      <p className="">
                                        At{" "}
                                        <strong>Joint Forces K9 Group</strong>,
                                        we help people with disabilities train
                                        reliable, task-capable service dogs. Our
                                        programs are individualized to your
                                        needs, schedule, and home life, with
                                        training available in your home or at
                                        our facility.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        What Is a Service Dog?
                                      ...
                                      <p className="">
                                        Under the ADA, a service dog is a dog
                                        that is individually trained to do work
                                        or perform tasks for a person with a
                                        disability (including physical, sensory,
                                        psychiatric, intellectual, or other
                                        mental disabilities). The work or tasks
                                        must directly mitigate the person&apos;s
                                        disability.
                                      </p>
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            alerting, guiding, retrieving,
                                            bracing) and have public-access
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            are service dogs; they perform
                                            trained tasks related to psychiatric
                                            disabilities.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            and therapy dogs provide comfort or
                                            therapeutic visitation but do not
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            is for general guidance only; if you
                                            have legal questions about access
                                            rights, consult ADA resources or an
                                            attorney.
                                          </span>
                                        </li>
                                      </ul>
                                      ...
                                      <p className="">
                                        There are several paths. We do not breed
                                        or sell service dogs; instead, we help
                                        you select an appropriate dog (or
                                        evaluate your current dog) and train it
                                        for task work and public access.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Our Process
                                      </h2>
                                      <ol className="list-decimal pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            We clarify your disability-related
                                            needs, daily routines, and
                                            environments to determine
                                            appropriate tasks and training
                                            milestones.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Dog Selection or Evaluation
                                            </strong>
                                            <br />
                                            We help you choose a candidate (or
                                            evaluate your current dog) for
                                            health, temperament, stability, and
                                            trainability.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Foundations & Public Manners
                                            </strong>
                                            <br />
                                            Neutrality around people, dogs, and
                                            distractions; leash skills; impulse
                                            control; settling in public; and
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            We teach and proof
                                            disability-mitigating tasks tailored
                                            to your goals (see examples below),
                                            with step-by-step handler coaching.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            We proof behaviors in real-world
                                            settings and prepare you for
                                            handling, advocacy, and ongoing
                                            maintenance.
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            <br />
                                            You receive clear homework, progress
                                            benchmarks, and ongoing support to
                                            keep skills reliable.
                                          </span>
                                        </li>
                                      </ol>
                                      <p className="">
                                        Training is available in-home or at our
                                        facility to match your schedule and
                                        optimize real-life carryover.
                                      </p>
                                      <h2 className="text-xl font-bold text-brand-red">
                                        Types of Working Dogs We Train
                                      </h2>
                                      <ul className="list-disc pl-0">
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            (note: ESAs are not service dogs
                                            under the ADA)
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            (supports clinical/therapeutic
                                            settings; not ADA service dogs)
                                          </span>
                                        </li>
                                      </ul>
                                      <h2 className="text-xl font-bold text-brand-red">
                                      ...
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Interrupting or responding
                                            </strong>{" "}
                                            to anxiety episodes or dissociation
                                            cues (PSD)
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            or safe locations during overwhelm
                                            (PSD/ASD)
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            (phone, doorbell, smoke alarm) for
                                            hearing assistance
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            , light switches, and door operation
                                            (mobility)
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Counterbalance/brace assistance
                                            </strong>{" "}
                                            as approved by your medical team
                                            (mobility)
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                      ...
                                      <ul className="list-disc pl-0">
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            based on your disability, home life,
                                            and environments
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                        ...
                                        <li className="flex items-start">
                                          <span>
                                            <strong className="font-bold text-brand-red">
                                              Ethical, evidence-informed methods
                                            </strong>{" "}
                                            focused on reliability, neutrality,
                                            and safety
                                          </span>
                                        </li>
                                        <li className="flex items-start">
                                          <span>
                                            ...
                                            so you and your dog succeed together
                                            long-term
                                          </span>
                                        </li>
                                      </ul>
                                      ...
                                      <p>
                                        <strong>
                                          Ready to explore service dog training?
                                          Request a consultation to discuss your
                                          goals, dog suitability, and a
                  ...
                  <Card className="flex flex-col h-[600px] w-full gap-0 py-0">
                    <CardHeader className="gap-0 px-0">
                      <CardTitle className="text-2xl md:text-3xl font-bold text-brand-navy">
                        Dog Boarding in Northwest Arkansas
                      </CardTitle>
                    </CardHeader>
                    <CardContent className="p-0 flex-grow overflow-y-auto custom-scrollbar px-0">
                      <div className="p-0">
                        <div className="prose prose-slate dark:prose-invert max-w-none m-0 p-0">
                          <div>
                            <p className="">
                              <strong>Joint Forces K9</strong> provides
                              camp-style boarding for dogs of all sizes and
                              temperaments—no breed restrictions. Your pet stays
                              in our climate-controlled kennels, enjoys daily
                              socialization and exercise, and receives
                              attentive, personalized care from our experienced
                              team. We also welcome cats, so your whole crew can
                              be cared for in one convenient location.
                            </p>
                            ...
                            <p className="">
                              Our goal is a safe, low-stress, and enjoyable stay
                              every time.
                            </p>
                            ...
                            <p className="">
                              To protect the health of all pets in our care,
                              proof of current vaccinations is required before
                              boarding. Vaccines must be appropriate for your
                              dog&apos;s age and current as of the check-in
                              date.
                            </p>
                            <ul className="list-disc pl-0">
                              <li className="flex items-start">
                            ...
                            <p className="">
                              Pets who show signs of illness should not be
                              boarded. We monitor every guest for health and
                            ...
                            <p className="">
                              ...
                              <strong>$45 per night</strong>, regardless of
                              size, age, or breed.
                            </p>
                            ...
                            <ul className="list-disc pl-0">
                              <li className="flex items-start">
                                <span>
                                  ...
                                  and all holiday reservations require a deposit
                                  to hold your spot.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  ...
                                  is required in advance for boarding and is
                                  non-refundable.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  ...
                                  ; however, there is a pickup window from
                                  12:00–2:00 PM for boarding dogs only.
                                </span>
                              </li>
                            </ul>
                            ...
                            <p className="">
                              ...
                              <strong>Siloam Springs</strong>, proudly serving
                              families across{" "}
                              <strong>Northwest Arkansas</strong>, including{" "}
                              <strong>Fayetteville</strong>,{" "}
                              <strong>Springdale</strong>,{" "}
                              ...
                              <strong>West Fork</strong>,{" "}
                              <strong>Eureka Springs</strong>,{" "}
                              <strong>Goshen</strong>, <strong>Elkins</strong>,{" "}
                              <strong>Little Flock</strong>,{" "}
                              <strong>Bethel Heights</strong>, and{" "}
                              <strong>Highfill</strong>.
                            </p>
                            <p>
                              <strong>
                                If you have questions about suitability,
                                vaccination records, medications, or special
                                accommodations, contact us—we&apos;re happy to
                                help.
                              </strong>
                            </p>
                    ...
                    <CardContent className="p-0 flex-grow overflow-y-auto custom-scrollbar px-0">
                      <div className="p-0">
                        <div className="prose prose-slate dark:prose-invert max-w-none m-0 p-0">
                          <div>
                            <h2 className="text-xl font-bold text-brand-red">
                              Enhancing Safety & Security with Elite Scent
                              Detection Teams
                            </h2>

                            <p>
                              Joint Forces K9 Group provides confidential and
                              effective narcotics detection services for
                              businesses, schools, venues, and homeowners. Our
                              proactive K9 sweeps are a powerful deterrent,
                              helping you maintain a safe, drug-free
                              environment. Our highly trained scent detection
                              dogs and expert handlers offer peace of mind by
                              delivering fast, accurate, and discreet security
                              solutions across commercial, municipal, and
                              residential markets.
                            </p>
                            ...
                            <ul className="list-disc pl-0">
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Our K9s are trained to isolate the pure scent
                                  of a wide variety of narcotics, ignoring
                              ...
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Every handler is a professional, trained to
                                  manage the K9 and conduct searches with
                              ...
                              <li className="flex items-start">
                                <span>
                                  ...
                                  From large-scale event venues to private
                                  homes, our teams are equipped to handle any
                                  environment.
                                </span>
                              </li>
                            </ul>
                            ...
                            <p>
                              To protect all parties and ensure maximum
                              effectiveness, our process is built on a
                              foundation of safety and legality.
                            </p>
                            ...
                            <ol className="list-decimal pl-0">
                              <li className="flex items-start">
                                <span>
                                  ...
                                  We begin with express written consent from the
                                  property owner or legal representative.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  ...
                                  For the safety of all involved and the
                                  accuracy of the search, the premises are
                                  temporarily cleared of all occupants and pets.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  ...
                                  The owner or their representative must be
                                  present throughout the entire sweep to witness
                                  the process and receive immediate updates.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Our handler and K9 partner will meticulously
                                  search the property one room at a time.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  ...
                                  If a narcotic&#39;s odor is detected, our K9
                                  will give a passive alert. The handler will
                                  then discreetly mark the area and inform the
                            ...
                            <p>
                              Please note that our service is strictly for the
                              detection of a narcotic&#39;s odor. Joint Forces
                              K9 Group is not authorized to search for, handle,
                              or dispose of illegal substances. The
                              responsibility for locating and removing any
                              contraband from a marked area rests entirely with
                              the client.
                            </p>
                            ...
                            <ul className="list-disc pl-0">
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Helping to enforce drug-free campus policies
                              ...
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Protecting your employees, assets, and
                                  reputation from workplace drug issues.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span>
                                  <strong className="font-bold text-brand-red">
                                    Event Venues & Public Arenas:
                                  </strong>{" "}
                                  Providing proactive security screenings for
                              ...
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Aiding agencies in maintaining secure and
                              ...
                              <li className="flex items-start">
                                <span>
                                  ...
                                  Offering discreet, confidential searches for
                                  homeowners concerned about drug activity.
                                </span>
                              </li>
                            </ul>

                            <p className="">
                              We provide Narcotics Detection across all of
                              Northwest Arkansas (NWA). While our primary
                              facility is based in Siloam Springs, we are proud
                              to serve families throughout the region, including
                              Fayetteville, Springdale, Rogers, Bentonville,
                              Tontitown, Centerton, Bella Vista, Pea Ridge,
                              Gentry, Cave Springs, Gravette, Decatur,
                              Greenland, Lincoln, Farmington, Prairie Grove,
                              Johnson, West Fork, Eureka Springs, Goshen,
                              Elkins, Little Flock, Bethel Heights, and
                              Highfill.
                            </p>

                            <p className="text-center">
                              <strong>
                                Secure your peace of mind. Contact us today for
